...
public final class RaftOutter {
  ...
  public static final class EntryMeta extends com.google.protobuf.GeneratedMessageV3 implements
    ...
    protected FieldAccessorTable internalGetFieldAccessorTable() {
      return RaftOutter.internal_static_jraft_EntryMeta_fieldAccessorTable
              .ensureFieldAccessorsInitialized(EntryMeta.class,
                      Builder.class);
    }
    ...
    public static EntryMeta parseFrom(java.nio.ByteBuffer data)
            throws com.google.protobuf.InvalidProtocolBufferException {
    ...
    public static EntryMeta parseFrom(com.google.protobuf.ByteString data)
            throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static EntryMeta parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static EntryMeta parseFrom(java.io.InputStream input)
    ...
    public static EntryMeta parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    public static EntryMeta parseFrom(com.google.protobuf.CodedInputStream input)
            throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3.parseWithIOException(PARSER, input);
    }
    ...
    public static Builder newBuilder(EntryMeta prototype) {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
      ...
      public EntryMeta build() {
        EntryMeta result = buildPartial();
      ...
      public EntryMeta buildPartial() {
        EntryMeta result = new EntryMeta(
                this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EntryMeta) {
          return mergeFrom((EntryMeta) other);
        } else {
      ...
      public Builder mergeFrom(EntryMeta other) {
        if (other == EntryMeta.getDefaultInstance())
          return this;
        if (other.hasTerm()) {
      ...
      public Builder mergeFrom(com.google.protobuf.CodedInputStream input,
                               com.google.protobuf.ExtensionRegistryLite extensionRegistry)
              throws java.io.IOException {
        EntryMeta parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EntryMeta) e.getUnfinishedMessage();
    ...
    private static final EntryMeta DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new EntryMeta();
    }
  ...
  public static final class SnapshotMeta extends com.google.protobuf.GeneratedMessageV3 implements
    ...
    protected FieldAccessorTable internalGetFieldAccessorTable() {
      return RaftOutter.internal_static_jraft_SnapshotMeta_fieldAccessorTable
              .ensureFieldAccessorsInitialized(SnapshotMeta.class,
                      Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      SnapshotMeta other = (SnapshotMeta) obj;
    ...
    public static SnapshotMeta parseFrom(java.nio.ByteBuffer data)
            throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static SnapshotMeta parseFrom(com.google.protobuf.ByteString data)
            throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static SnapshotMeta parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static SnapshotMeta parseFrom(java.io.InputStream input)
            throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3.parseWithIOException(PARSER, input);
    }
    ...
    public static SnapshotMeta parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
    }
    ...
    public static SnapshotMeta parseFrom(com.google.protobuf.CodedInputStream input)
            throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3.parseWithIOException(PARSER, input);
    }
    ...
    public static Builder newBuilder(SnapshotMeta prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
      ...
      public SnapshotMeta build() {
        SnapshotMeta result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public SnapshotMeta buildPartial() {
        SnapshotMeta result = new SnapshotMeta(
                this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SnapshotMeta) {
          return mergeFrom((SnapshotMeta) other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(SnapshotMeta other) {
        if (other == SnapshotMeta.getDefaultInstance())
          return this;
      ...
      public Builder mergeFrom(com.google.protobuf.CodedInputStream input,
                               com.google.protobuf.ExtensionRegistryLite extensionRegistry)
              throws java.io.IOException {
        SnapshotMeta parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (SnapshotMeta) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    private static final SnapshotMeta DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SnapshotMeta();
    }
  ...
  static {
    ...
    internal_static_jraft_EntryMeta_fieldAccessorTable = new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
            internal_static_jraft_EntryMeta_descriptor, new String[] { "Term", "Type", "Peers", "DataLen",
    ...
    internal_static_jraft_SnapshotMeta_fieldAccessorTable = new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
            internal_static_jraft_SnapshotMeta_descriptor, new String[] { "LastIncludedIndex",
