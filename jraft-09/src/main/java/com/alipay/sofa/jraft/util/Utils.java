 ...
 * @Date:2023/11/20
 * @Description:从源码中直接复制过来的工具类，这个类中的方法逻辑都很简单，大家看看就行
 */
public final class Utils {
    ...
    private static class AppendEntriesThreadPoolHolder {
        private static final FixedThreadsExecutorGroup INSTANCE = DefaultFixedThreadsExecutorGroupFactory.INSTANCE.newExecutorGroup(
     ...
     * Deprecated, {@link ThreadPoolsFactory}
     */
    @Deprecated
