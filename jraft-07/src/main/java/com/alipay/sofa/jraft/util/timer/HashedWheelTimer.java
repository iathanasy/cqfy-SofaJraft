 ...
 * @Date:2023/11/20
 * @Description:时间轮定时任务调度器，老朋友了，不管是在Netty，还是在xxljob中都已经学过了，这个类就不再添加注释了
 * 如果有朋友不太理解这个类，就把我提供的Netty的代码和小册找出来看一看对应章节，别看这个类现在在jraft框架中，实际上它就是Netty中的时间轮，搬运过来了而已
 */
public class HashedWheelTimer implements Timer {
    ...
    private static final AtomicIntegerFieldUpdater<HashedWheelTimer> workerStateUpdater = AtomicIntegerFieldUpdater.newUpdater(
